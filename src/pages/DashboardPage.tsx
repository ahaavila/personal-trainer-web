...
function DashboardPage() {
  ...
  if (!data) return null
  return isPersonalData(data) ? <PersonalDashboard data={data} userName={user.name} /> : <StudentDashboard data={data} />
}
