...
function PersonalDashboard({ data, userName }: { data: PersonalDashboardData; userName: string }) {
  ...
  return <div className="dashboard-view">
    <div className="dashboard-view__header"><div><span className="dashboard-view__date">{formatDate()}</span><h1>Olá, {userName}.</h1><p>Aqui está o panorama dos seus acompanhamentos hoje.</p></div><div className="dashboard-view__actions"><Link className="dashboard-button dashboard-button--muted" to="/exercicios"><Plus size={17} /> Novo exercício</Link><Link className="dashboard-button dashboard-button--primary" to="/alunos"><Users size={17} /> Adicionar aluno</Link></div></div>
